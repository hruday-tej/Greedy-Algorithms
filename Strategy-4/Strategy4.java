...
class Strategy4Comparator implements Comparator<Bag> {
    ...
    public int compare(Bag b1, Bag b2) {
        /*
         * Here we calculate the ratios for the increase in the percentage and then perform heapify
        ...
        double ratio1 = ((double)((double)(b1.workingDevices+1)/(double)(b1.totalDevices+1)) - (double)((double)(b1.workingDevices)/(double)(b1.totalDevices)));
        double ratio2 = ((double)((double)(b2.workingDevices+1)/(double)(b2.totalDevices+1)) - (double)((double)(b2.workingDevices)/(double)(b2.totalDevices)));
...
public class Strategy4 {
    public static void main(String[] args) {
        ...
        for(int iterator=0;iterator<n;iterator++){
            ...
            // System.out.println("BAGSSS -> "+bags[iterator].totalDevices + " " + bags[iterator].workingDevices);
            pq.add(inputBag);
        }
        scanner.close();
        ...
        while(k > 0){
             ...
             * according to strategy-4 we pick the bag with the greatest increase in percentage
